...
export const SEASON_DERIVED_STATS_2026_27: SeasonDerivedStats = {
  scorers: [
    ...
    { id: 'fifa-1jwu0l8', name: 'Rodino Jose', club: 'Wiliete de Benguela', teamId: 'wiliete', position: 'Avançado', goals: 1, appearances: 2 },
    ...
    { id: 'valter-monteiro', name: 'Valter Monteiro', club: 'Wiliete de Benguela', teamId: 'wiliete', position: 'Médio', goals: 1, appearances: 1 },
