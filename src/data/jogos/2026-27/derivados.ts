...
export const SEASON_DERIVED_STATS_2026_27: SeasonDerivedStats = {
  scorers: [
    ...
    { id: 'fifa-1jwu0l8', name: 'Rodino Jose', club: 'Wiliete de Benguela', teamId: 'wiliete', position: 'Avançado', goals: 2, appearances: 3 },
    ...
    { id: 'fifa-1qvfjm7', name: 'Bocar Sidibé', club: 'Wiliete de Benguela', teamId: 'wiliete', position: 'Médio', goals: 1, appearances: 2 },
    ...
    { id: 'cuxixima-libolo', name: 'Cuxixima', club: 'Recreativo do Libolo', teamId: 'libolo', position: 'Avançado', goals: 1, appearances: 2 },
