...
// 5.ª jornada · 20/09/2026 · Kabuscorp SC 1-0 GD Interclube (resultado final)
...
export default defineMatch({
  ...
  events: [
    { minute: 101, type: 'goal', team: 'home', player: 'Joaquim Paciencia', number: 19, playerId: 'fifa-1jm8hd7', detail: "90'+11' (1-0)" },
  ],
});
