...
// 5.ª jornada · 20/09/2026 · Wiliete 5-0 Libolo ao minuto 88 (jogo a decorrer)
...
export default defineMatch({
  ...
  result: { status: 'live', homeScore: 5, awayScore: 0, halfTimeScore: '1-0', liveMinute: 88, updatedAt: '2026-09-20T18:15:00+01:00' },
  ...
  events: [
    ...
    { minute: 82, type: 'goal', team: 'home', player: '', detail: "82' · autor por confirmar (4-0)" },
    { minute: 87, type: 'goal', team: 'home', player: '', detail: "87' · autor por confirmar (5-0)" },
  ],
});
