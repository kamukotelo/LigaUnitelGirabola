...
export default function LigaTv() {
  ...
  return (
    <main className="min-h-screen bg-black text-white p-6 md:p-12 relative z-10">
      ...
      <header className="mb-12 flex items-center justify-between relative z-10">
        <div>
          ...
          <h1 className="text-5xl md:text-7xl font-display uppercase font-black text-white leading-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-zinc-900/40 p-6 rounded-2xl border border-zinc-900">
            ...
            <h2 className="text-2xl font-display uppercase font-bold text-white mt-1 leading-snug">{activeVideo.title}</h2>
            <div className="flex items-center gap-4 text-xs font-mono text-zinc-500 mt-4 pt-4 border-t border-zinc-900/80">
          ...
          <div className="space-y-4">
            {playlist.map((video) => (
              <div 
                ...
                className="flex gap-4 p-3 bg-zinc-900/30 hover:bg-zinc-900/60 border border-zinc-900 rounded-xl cursor-pointer transition-all duration-300 group"
              >
                <div className="w-28 h-20 bg-zinc-950 rounded-lg relative overflow-hidden flex-shrink-0 flex items-center justify-center text-zinc-600 group-hover:text-primary transition-colors border border-zinc-900">
