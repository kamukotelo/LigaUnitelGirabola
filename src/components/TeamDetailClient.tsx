...
export default function TeamDetailClient({
  ...
  return (
    <div className="content-shell py-12 relative z-10 overflow-hidden">
      ...
      <AnimatedCard variant="holographic" className="bg-zinc-100/40 dark:bg-zinc-950/40 border-zinc-200/80 dark:border-zinc-900/80 p-5 sm:p-8 pt-16 sm:pt-8 mb-6 sm:mb-8 relative overflow-hidden">
        <div className="absolute top-4 right-4 flex items-center gap-1.5 sm:gap-2">
          <span className="h-2.5 w-2.5 sm:h-3 sm:w-3 shrink-0 rounded-full bg-red-600 animate-pulse" />
          <span className="update-alert text-[10px] sm:text-xs font-mono font-black uppercase tracking-wide">
            EM_ATUALIZAÇÃO
          </span>
        </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 pt-3 sm:pt-4 border-t border-zinc-200/60 dark:border-zinc-900/60 text-xs font-mono text-zinc-600 dark:text-zinc-400">
              ...
              <div className="space-y-1">
                ...
                {profile ? (
                  ...
                  >
                    <Trophy size={12} className="text-accent shrink-0" /> {team.stadium}
                  </a>
                ) : (
