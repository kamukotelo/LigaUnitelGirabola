...
insert into public.ancaf_videos (id, title, duration, views, category, thumbnail, video_url, is_live, sort) values
  ('sorteio-girabola-gala-2026', 'Sorteio Oficial do Calendário & 1.ª Gala de Premiação — Liga Unitel Girabola', 'Especial Gala', '24.8K visualizações', 'Gala Oficial', 'https://i.ytimg.com/vi/oUla8ksfQIg/hqdefault.jpg', 'https://www.youtube.com/embed/oUla8ksfQIg?autoplay=1', false, 0),
