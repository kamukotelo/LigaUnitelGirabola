...
Baseado no guia completo (17 slides, fundo oficial #071A2B, formato 16:9 widescreen).
Atualizado e auditado com os dados reais do sistema ANCAF / Liga Unitel Girabola.
"""
...
# Cores oficiais do Girabola (Tema Escuro #071A2B)
COR_FUNDO         = RGBColor(7, 26, 43)        # #071A2B
COR_AZUL_SEC      = RGBColor(12, 39, 57)       # #0C2639
COR_AZUL_CARD_ALT = RGBColor(16, 48, 72)       # #103048
COR_AZUL_DEST     = RGBColor(8, 120, 201)      # #0878C9
COR_VERDE         = RGBColor(24, 182, 106)     # #18B66A
COR_DOURADO       = RGBColor(242, 201, 76)     # #F2C94C
COR_VERMELHO      = RGBColor(230, 57, 70)      # #E63946
COR_BRANCO        = RGBColor(255, 255, 255)
COR_CINZA_TEXTO   = RGBColor(180, 195, 210)
COR_CINZA_MUTED   = RGBColor(120, 140, 160)
...
# ==========================================
# DADOS OFICIAIS DA 3.ª JORNADA (ANCAF / GIRABOLA 2026/27)
# ==========================================

# 8 Jogos da 3.ª Jornada
jogos_r3 = [
    {
...
# Tabela Completa Oficial (16 Clubes)
tabela_oficial = [
    {"pos": "01", "equipa": "CD 1.º DE AGOSTO",        "j": 3, "v": 3, "e": 0, "d": 0, "gm": 5, "gs": 2, "dg": "+3", "pts": 9},
    {"pos": "02", "equipa": "PETRO DE LUANDA",         "j": 3, "v": 2, "e": 1, "d": 0, "gm": 5, "gs": 0, "dg": "+5", "pts": 7},
    {"pos": "03", "equipa": "BRAVOS DO MAQUIS",        "j": 3, "v": 2, "e": 0, "d": 1, "gm": 4, "gs": 1, "dg": "+3", "pts": 6},
    {"pos": "04", "equipa": "WILIETE DE BENGUELA",     "j": 2, "v": 2, "e": 0, "d": 0, "gm": 4, "gs": 1, "dg": "+3", "pts": 6},
    {"pos": "05", "equipa": "GD INTERCLUBE",           "j": 3, "v": 2, "e": 0, "d": 1, "gm": 4, "gs": 3, "dg": "+1", "pts": 6},
    {"pos": "06", "equipa": "ESTRELA 1.º DE MAIO",     "j": 3, "v": 1, "e": 1, "d": 1, "gm": 4, "gs": 3, "dg": "+1", "pts": 4},
    {"pos": "07", "equipa": "CR CAÁLA",                "j": 3, "v": 1, "e": 1, "d": 1, "gm": 3, "gs": 3, "dg": "0",  "pts": 4},
    {"pos": "08", "equipa": "FC DE LUANDA",            "j": 3, "v": 1, "e": 1, "d": 1, "gm": 3, "gs": 3, "dg": "0",  "pts": 4},
    {"pos": "09", "equipa": "DESPORTIVO DA HUÍLA",     "j": 2, "v": 1, "e": 0, "d": 1, "gm": 2, "gs": 2, "dg": "0",  "pts": 3},
    {"pos": "10", "equipa": "RECREATIVO DO LIBOLO",    "j": 3, "v": 1, "e": 0, "d": 2, "gm": 3, "gs": 4, "dg": "-1", "pts": 3},
    {"pos": "11", "equipa": "SAGRADA ESPERANÇA",       "j": 2, "v": 1, "e": 0, "d": 1, "gm": 3, "gs": 4, "dg": "-1", "pts": 3},
    {"pos": "12", "equipa": "SÃO SALVADOR DO KONGO",   "j": 3, "v": 1, "e": 0, "d": 2, "gm": 2, "gs": 4, "dg": "-2", "pts": 3},
    {"pos": "13", "equipa": "KABUSCORP SC",            "j": 2, "v": 0, "e": 2, "d": 0, "gm": 2, "gs": 2, "dg": "0",  "pts": 2},
    {"pos": "14", "equipa": "DESPORTIVO DA LUNDA SUL", "j": 3, "v": 0, "e": 2, "d": 1, "gm": 2, "gs": 3, "dg": "-1", "pts": 2},
    {"pos": "15", "equipa": "FC DE CABINDA",           "j": 3, "v": 0, "e": 0, "d": 3, "gm": 2, "gs": 7, "dg": "-5", "pts": 0},
    {"pos": "16", "equipa": "ACADÉMICA DO LOBITO",     "j": 3, "v": 0, "e": 0, "d": 3, "gm": 0, "gs": 6, "dg": "-6", "pts": 0},
]
...
add_shape(slide1, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.0), Inches(1.8), Inches(3.5), Inches(3.8), COR_AZUL_SEC, COR_AZUL_DEST)
...
# -------------------------------------------------------------
# SLIDE 3 — RESULTADOS DA 3.ª JORNADA
# -------------------------------------------------------------
...
for i, m in enumerate(jogos_r3):
    ...
    add_shape(slide3, MSO_SHAPE.ROUNDED_RECTANGLE, x, y, Inches(2.8), Inches(2.5), COR_AZUL_SEC, borda_box)
...
# -------------------------------------------------------------
# SLIDE 4 — JOGO DA JORNADA
# -------------------------------------------------------------
slide4 = prs.slides.add_slide(prs.slide_layouts[6])
aplicar_fundo_escuro(slide4)
add_header(slide4, "Dérbi de Luanda", "Jogo da Jornada: Reviravolta Militar aos 90'")

add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.8), Inches(1.5), Inches(6.0), Inches(5.3), COR_AZUL_SEC, COR_AZUL_DEST)
...
add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.2), Inches(1.5), Inches(5.3), Inches(5.3), COR_AZUL_CARD_ALT, COR_DOURADO)
...
# -------------------------------------------------------------
# SLIDE 5 — TABELA DE CLASSIFICAÇÃO
# -------------------------------------------------------------
...
add_shape(slide6, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.6), Inches(1.5), Inches(2.9), Inches(5.2), COR_AZUL_SEC, COR_AZUL_DEST)
...
add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.6), Inches(1.5), Inches(2.9), Inches(5.2), COR_AZUL_SEC, COR_VERDE)
...
add_shape(slide9, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.8), Inches(1.5), Inches(5.8), Inches(5.3), COR_AZUL_SEC, COR_DOURADO)
...
add_shape(slide9, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.0), Inches(1.5), Inches(5.5), Inches(5.3), COR_AZUL_CARD_ALT, COR_AZUL_DEST)
...
add_shape(slide10, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(9.6), Inches(1.5), Inches(2.9), Inches(5.2), COR_AZUL_SEC, COR_DOURADO)
...
add_shape(slide12, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.8), Inches(4.2), Inches(11.733), Inches(2.5), COR_AZUL_CARD_ALT, COR_AZUL_DEST)
...
add_shape(slide17, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(2.0), Inches(1.8), Inches(9.333), Inches(4.0), COR_AZUL_SEC, COR_DOURADO)
